...
module.exports =  function (){
    ...
    async function createAdmin(id_admin,name_admin,email,password,id_gym){
        await pool.query('INSERT INTO admin (id_admin,name_admin,password,id_gym,email) VALUES ($1,$2,$3,$4,$5)',[id_admin,name_admin,password,id_gym,email])
